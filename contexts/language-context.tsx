...
const translations = {
  en: {
    ...
    tokenSubtitle:
      "Ticker: $HeroX • Distribution: 15% Team • 85% Liquidity • Utility: Rewards for top players, future expansions.",
    ...
    tokenTeamPercent: "15% Team",
    tokenLiquidityPercent: "85% Liquidity",
  ...
  zh: {
    ...
    tokenTeamPercent: "15% 团队",
    tokenLiquidityPercent: "85% 流动性",
